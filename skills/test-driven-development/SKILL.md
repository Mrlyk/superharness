...
- Log `implement:tdd_red` when writing a failing test (RED phase verified)
- Log `implement:tdd_green` when the test passes (GREEN phase verified)
- These entries provide an audit trail proving the red-green cycle was followed
...
- [ ] Trace events logged to trace.jsonl for each red-green cycle
